...
// Payload data for different device types
...
void updateDeviceType() {
  ...
  if (millis() - lastSwitchMillis >= 1000) {  // Check if 2 seconds have passed
    lastSwitchMillis = millis();  // Reset the timer
    deviceType = (deviceType % 26) + 1;  // Switch to the next device type (cycling from 1 to 26)
  }
}

void loop() {
  updateDeviceType();  // Check and update device type every 2 seconds
